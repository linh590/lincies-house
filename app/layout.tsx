...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Khóa học có được bổ sung nội dung không?", acceptedAnswer: { "@type": "Answer", text: "Có. Khóa học được update và bổ sung bài học mới khi Airbnb có tính năng mới, chính sách mới hoặc tình huống thực tế quan trọng/phù hợp với việc vận hành. Đây không phải cam kết cập nhật mọi thay đổi ngay lập tức." } },
  ],
};
