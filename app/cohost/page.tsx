  ...
  return (
    <main className="page cohost-detail-page">
      <nav className="nav">
        ...
        <div className="navlinks"><a href="/#course">Chương trình học</a><a href="/#pricing">Học cùng Linh</a><a href="/cohost">Co-host</a><a href="/shop">Shop</a><a href="/#faq">Giải đáp</a></div>
