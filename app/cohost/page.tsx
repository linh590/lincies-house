...
const whyLinh = [
  "7 năm kinh nghiệm hosting Airbnb tại Mỹ.",
        ...
        <div className="cohost-detail-hero-grid">
          <div className="cohost-detail-hero-copy">
            ...
            <div className="cohost-hero-copy">
              ...
              <p>Airbnb cần chiến lược setup đúng ngay từ đầu, pricing hợp lý, guest experience tốt và tối ưu liên tục theo thị trường. Với 7 năm kinh nghiệm hosting/Superhost và trực tiếp vận hành nhiều mô hình Airbnb tại Mỹ, Linh hỗ trợ chủ nhà setup và vận hành theo hướng thực tế, tối ưu và có hệ thống hơn.</p>
            </div>
